...
bool loadTextShaders() {
  ...
  if (!texture_2DA_vertex_shader) {
    ...
    glShaderSource(texture_2DA_vertex_shader, 1,
                   &texture_2DA_vertex_shader_source, NULL);
    glCompileShader(texture_2DA_vertex_shader);
    glGetShaderiv(texture_2DA_vertex_shader, GL_COMPILE_STATUS,
                  &success);
    if (!success) {
      glGetShaderInfoLog(texture_2DA_vertex_shader, INFOLOG_LEN,
                         NULL, infoLog);
  ...
  if (!texture_2DA_fragment_shader) {
    ...
    glShaderSource(texture_2DA_fragment_shader, 1,
                   &texture_2DA_fragment_shader_source, NULL);
    glCompileShader(texture_2DA_fragment_shader);
    glGetShaderiv(texture_2DA_fragment_shader, GL_COMPILE_STATUS,
                  &success);
    if (!success) {
      glGetShaderInfoLog(texture_2DA_fragment_shader, INFOLOG_LEN,
                         NULL, infoLog);
  ...
  if (!texture_2DA_shader_program) {
    ...
    glAttachShader(texture_2DA_shader_program,
                   texture_2DA_vertex_shader);
    glAttachShader(texture_2DA_shader_program,
                   texture_2DA_fragment_shader);
